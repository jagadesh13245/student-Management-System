...
(1, 'aboutus', 'About Us', '<div style=\"text-align: start;\"><font color=\"#7b8898\" face=\"Mercury SSm A, Mercury SSm B, Georgia, Times, Times New Roman, Microsoft YaHei New, Microsoft Yahei, ????, ??, SimSun, STXihei, ????, serif\"><span style=\"font-size: 26px;\">Vision
RMDEC aspires to be a premier institution offering quality technical education and research with application expertise in Engineering and Technology.

Mission
Develop the students as outstanding professionals by creating an environment that would nurture creativity, academic excellence, professionalism, high standard of ethics, sense of responsibility and respect for individuals. .

Provide an efficient academic and research environment.

Interact with corporates, industries and research institutions to work on collaborative projects and sponsored research.

Establish centers of excellence to impart Domain Specific industry skills.

Encourage the faculty to excel in their teaching and research careers.

Contribute more to the education and training of rural folk as societal obligation..</span></font><br></div>', NULL, NULL, NULL),
